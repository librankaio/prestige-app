                            ...
                            <table class="table table-bordered" id="datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="border border-5" style="text-align: center;">Email</th>
                                        <th scope="col" class="border border-5" style="text-align: center;">Social Media</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border border-5" style="text-align: center;">{{ $item->email }}</td>
                                        <td class="border border-5" style="text-align: center;">{{ $item->socmed }}</td>
