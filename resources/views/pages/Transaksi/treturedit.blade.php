                                    ...
                                    <section class="uploadimg">
                                        <div class="row py-2">
                                            <div class="col-md-12">
                                                ...
                                                <div class="image-area mt-4"><img id="imageResult1" src="{{ asset('storage/images/'.$tretur->pict) }}" alt="" class="img-fluid rounded shadow-sm mx-auto d-block"></div>
                                                <input type="text" class="form-control" id="hdnupload1" name="hdnupload1" readonly value="{{ $tretur->pict }}" hidden>
                                                <hr>
                                            </div>
                                        </div>
                                    </section>
